...
for index, row in df.iterrows():
    popup_text = f"<b>{row['NAME']}</b><br>Height: {row['ELEV']} meters<br><a href='{row.get('WIKI_LINK')}' target='_blank'>More info</a>"  # Tekst do okienka pop-up z dodatkowym kodem HTML
