...
# Dodaj warstwę punktową dla wulkanów
...
folium.GeoJson(
    world_geojson,
    name='Countries',
    style_function=lambda x: {'fillColor': 'yellow', 'fillOpacity': 0.3, 'color': 'blue'}  # zmieniono kolor na żółty
).add_to(map)
